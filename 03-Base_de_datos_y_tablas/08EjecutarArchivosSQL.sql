...
# para ejecutar con un archivo SQL , donde 'admin' es nuestra contrasenia
    -- mysql -u root -p < /curso_db/setencias.sql
# otra forma de ejecutar es con source, dentro de MYSQL, donde 'admin' es nuestra contrasenia
    -- mysql -u root -p
