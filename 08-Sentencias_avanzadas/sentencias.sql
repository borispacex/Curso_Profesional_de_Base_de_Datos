...
-- creamos la tabla de libros_usuarios
...
-- actualizamos las definiciones de la tabla ventas y stock
...
-- insertamos datos a libros_usuarios
...
-- cambiamos los valores de paginas y ventas en la tabla de libros
